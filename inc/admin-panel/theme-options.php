            ...
            <div id="optionsframework-metabox">
                <div id="optionsframework" class="postbox">
                    <form id="form-options" method="post" action="options.php">
                        ...
                        <div class="form-row">
                            <label class="block"><?php _e('Współpracownicy','profitmag'); ?></label>
                            <textarea id="coworkersTextarea" name="coworkersTextarea" rows="20" cols="100" style="resize: none;" data-role="none"><?php //don't move it white signs in textarea appear :D
                            $handler = fopen($_SERVER['DOCUMENT_ROOT'] . "wp-content/themes/profitmag/coworkers.txt", "r") or die("Unable to open file!");
                            while(!feof($handler)){
                                echo fgets($handler);
                            }
                            //don't move it white signs in textarea appear :D?></textarea>
                            <p class="f13"><em><?php _e('1. Znacznik [..NEXT..] przed i po każdym użytkowniku <br>2. Jeśli nie będzie opisu albo obrazka zostanie wczytany domyślny (plik archive.php linia 111 i 114)<br>3. Opis max. 1137 znaki, jeśli będzie za długi to zostanie obcięty, zmiana - linia 85 w archive.php<br>4. Przykładowy plik:<br>[..NEXT..]<br>usernameMichal<br>fotka.pl/photo.jpg<br>bardzodlugiopis<br>[..NEXT..]<br>usernameRedaktor<br>www.fotka.pl/redPhoto.png<br>jakis opis<br>[..NEXT..]<br>5. Plik interpretuje HTML!<br>6. Pliki funkcjonalności (w razie potrzeby zmiany): archive.php, options.php (na początku), coworkers.txt, theme-options.php, Portrait300300.jpg<br>','profitmag'); ?></em></p>
                        </div>
                        </div>
			            ...
			            <div id="optionsframework-submit">
            			     <input type="submit" class="button-primary" value="<?php esc_attr_e('Save Options i współpracowników','profitmag'); ?>" />
            			</div>
                        </form>
