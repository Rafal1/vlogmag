	...
	<footer id="colophon" class="site-footer clearrfix" role="contentinfo">
        <div class="wrapper footer-wrapper clearfix">
                ...
                <div class="top-bottom clearfix">
                		<div id="footer-top">
                            <div class="footer-columns">
                                <!--
                                <?php // if( is_active_sidebar( 'fo-top-col-one' ) || is_active_sidebar( 'fo-top-col-two' ) || is_active_sidebar( 'fo-top-col-three' ) || is_active_sidebar( 'fo-top-col-four' ) ||                                    // is_active_sidebar( 'fo-top-col-five' ) ||  is_active_sidebar( 'fo-top-col-six' ) ) : ?>
                                                    ...
                                                    <div class="footer1 col">
                                                        <div class="footer-logo">
                                                            <aside id="text-4" class="widget widget_text">			
                                                                <div class="textwidget"><!--<img src="http://vlogmag.cba.pl/wordpress/wp-content/uploads/2015/01/Logo22228.png"> -->
                                                                </div>
                		                                    </aside>                                            
                                                        </div>
                                                        ...
                                                        <div class="social-links">
                                                            <div class="socials">
                                            		    		<a href="https://www.facebook.com/pages/vlogmagpl/378442802321482" class="facebook" data-title="Facebook" target="_blank"><span class="font-icon-social-facebook"><i class="fa fa-facebook"></i></span></a>                        		    
                                                     ...
                                                     <div class="footer2 col">
                                                             <aside  class="widget widget_nav_menu"><h3 class="widget-title"><span>Partnerzy</span></h3>
                                                                <div class="menu-menu-1-container">
                                                                    <ul id="menu-menu-1" class="menu">
                                                                        <li><a href="https://www.facebook.com/mflyingshoes" target="_blank">Flying shoes</a></li>
                                                     ...
                                                     <div class="footer2 col">
                                                             <aside  class="widget widget_nav_menu"><h3 class="widget-title"><span>Blogosfera</span></h3>
                                                                <div class="menu-menu-1-container">
                                                                    <ul id="menu-menu-1" class="menu">
                                                     ...
                                                     <div class="footer2 col">
                                                             <aside  class="widget widget_nav_menu"><h3 class="widget-title"><span></span></h3>
                                                                <div class="menu-menu-1-container">
                                                                    <ul id="menu-menu-1" class="menu">
                                                                      <!--  <li><a href="#">Footer 1</a></li>
                                                                        <li><a href="#">Footer 2</a></li>
                                                     ...
                                                     <div class="footer2 col">
                                                             <aside  class="widget widget_nav_menu"><a href="www.vlogmag.pl/kontakt"><h3 class="widget-title"><span>Kontakt</span></h3></a>
                                                                <div class="menu-menu-1-container">
                                                                    <ul id="menu-menu-1" class="menu">
                                                                        <li><a href="#">kontakt@vlogmag.pl</a></li>
                                                                     <!--   <li><a href="#">Footer 2</a></li>
                                                                        <li><a href="#">Footer 3</a></li>
                                                                        <li><a href="#">Footer 3</a></li>
                                                                        <li><a href="#">Footer 4</a></li> -->
                ...
                <div class="footer-copyright border t-center">
                    ...
                    <noscript>
                        <div><a href="http://www.w3counter.com"><img src="https://www.w3counter.com/tracker.php?id=90193" style="border: 0" alt="W3Counter" /></a></div>
                    </noscript>
