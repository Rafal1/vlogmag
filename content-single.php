...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="single-feat clearfix">
        ...
        <div class="related-post">
            <h2 class="block-title"><span class="bordertitle-red"></span><?php echo _e( 'Powiązane wpisy', 'profitmag'); ?></h2> <!-- OMG! -->
	...
	<footer class="entry-footer">
			...
			<span class="cat-links">
				<?php printf( __( 'Kategoria %1$s', 'profitmag' ), $categories_list ); ?>
			</span>
			...
			<span class="tags-links">
				<?php printf( __( 'Tag %1$s', 'profitmag' ), $tags_list ); ?>
			</span>
