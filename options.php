...
unlink($_SERVER['DOCUMENT_ROOT'] . "/wp-content/themes/profitmag/coworkers.txt");	
$handler = fopen($_SERVER['DOCUMENT_ROOT'] . "wp-content/themes/profitmag/coworkers.txt", "w+") or die("Unable to open file!");	
$strToWrite = str_replace("\r","", $_POST["coworkersTextarea"]); 
fwrite($handler, $strToWrite);
fclose($handler);	
