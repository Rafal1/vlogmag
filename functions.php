...
if ( function_exists( 'add_image_size' ) ) { 
    ...
    add_image_size( 'three-col-thumb', 363, 209, true ); //!!
    ...
    add_image_size( 'gallery-full', 818, 537, true ); //GALERRY
...
update_option('siteurl','http://www.vlogmag.pl');
update_option('home','http://www.vlogmag.pl');